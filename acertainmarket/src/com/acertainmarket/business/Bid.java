...
public final class Bid {
	...
	public boolean equals(Object obj){
		...
		return ((this.buyerOrganizationID == bid.getBuyerOrganizationID())
				&& this.getItemID()==(bid.getItemID())
				&& this.getBidAmount() == bid.getBidAmount());
	}
	
	public String toString(){
		String bidString = "BUYER ORGANIZATION ID = " + this.buyerOrganizationID +
				"ITEM ID = " + this.getItemID() +
				"BID AMOUNT =" + this.getBidAmount();
		return bidString;
	}
	
	public int hashCode(){
		return getBuyerOrganizationID();
